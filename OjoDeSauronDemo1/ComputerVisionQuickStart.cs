...
namespace OjoDeSauronDemo1
{
    class ComputerVisionQuickStart
    {
        ...
        public int ReviewPersons()
        {
            ...
            AnalyzeImageUrl(client, ANALYZE_URL_IMAGE, true).Wait();
         ...
         */
        public static async Task AnalyzeImageUrl(ComputerVisionClient client, string imageUrl, bool isImageUrl)
        {
            Console.WriteLine("----------------------------------------------------------");
