...
namespace OjoDeSauronDemo1
{
    class ComputerVisionQuickStart
    {
        ...
        // URL image used for analyzing an image (image of puppy) this is for the case when you want to use an image on internet
        ...
        public int ReviewPersons()
        {
            ...
            string imagelocation = Path.Combine(Path.GetPathRoot( Directory.GetCurrentDirectory() ),  "temp", "img", "Ejemplo05.PNG");
        ...
        public static async Task<int> AnalyzeImageUrl(ComputerVisionClient client, string imageUrl, bool isImageUrl)
        {
            ...
            foreach (var obj in results.Objects)
            {
                ...
                if ( obj.ObjectProperty.Equals("person") ) // you should add a validation for a minimum value of obj.Confidence
                {
                    answer++;
                }
            }
